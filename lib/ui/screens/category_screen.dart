      ...
      body: Consumer<ExpenseProvider>(
        builder: (context, provider, child) {
          ...
          return ReorderableListView.builder(
            ...
            buildDefaultDragHandles: false, // We will add custom handles
              ...
              return Container(
                ...
                child: ListTile(
                  ...
                  leading: Container(
                    ...
                    decoration: BoxDecoration(
                      color: hexToColor(cat.color).withOpacity(0.1), 
                    ...
                    children: [
                      ...
                      ReorderableDragStartListener(
                        ...
                        child: Container(
                          ...
                          child: Icon(LucideIcons.gripVertical, color: theme.dividerColor, size: 20),
                        ),
                      ),
                    ],
                  ),
